...
func _ready():
	...
	avatar_right.connect("pressed", _next_avatar)
	avatar_ok.connect("pressed", _register)
	avatar_left.connect("pressed", _prev_avatar)
...
func _choose_avatar():
	...
	avatar_animation_player.play("walk_left")
...
func _update_sprite():
	avatar_sprite.set_region_rect(Rect2(avatar_id * 72, 0, 72, 128))
